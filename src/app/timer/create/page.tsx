...
export default function CreateTimerPage() {
  ...
  const [steps, setSteps] = useState([
    {
      id: Date.now().toString(), // Temp ID for UI management
      name: '',
      restDuration: 60, // Default values
      repetition: 1,
      exercises: [
        {
          id: Date.now().toString() + '-1', // Temp ID for UI management
          name: '',
          duration: 30, // Default values
          restDuration: 30,
          repetition: 1,
        },
      ],
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Transform the data for API submission (removing temporary IDs)
      const payload = {
        name: timerName,
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="card bg-base-100 shadow-lg">
            <div className="card-body">
              <h2 className="card-title text-primary">Timer Details</h2>
          ...
          {/* Add Step Button */}
          <button type="button" onClick={addStep} className="btn btn-outline btn-secondary w-full">
